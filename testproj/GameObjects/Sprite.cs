...
namespace MonoRider
{
    public class Sprite
    {
        ...
        private Enums.SpriteTags tag = Enums.SpriteTags.kNoneType;
        ...
        public Enums.SpriteTags _Tag { get => tag; set => tag = value; }
        ...
        public virtual void LoadContent(string path, ContentManager content)
        {
            ...
            cornerTex = content.Load<Texture2D>("Collision");
            frameHeight = _Texture.Height;
            frameWidth = _Texture.Width;
            //cornerTex = content.Load<Texture2D>("Art/Corner");


            List<Vector2> playerCorners = ExtendedTest.HelperFunctions.RotatedRectList(this._BoundingBox, _Rotation);
        ...
        public virtual void ResetSelf()
        {
            ...
            _Tag = Enums.SpriteTags.kNoneType;
            _Rotation = 0.0f;
        ...
        public virtual void Deactivate()
        {
            ...
            _Draw = false;
            _Position = new Vector2(-2000, -5000);
            showCorners = false;
        }


        public void ToggleCorners(Rectangle rect)
        {
            if (showCorners)
            {
                foreach (Sprite sprite in corners)
        ...
        {
            List<Vector2> myCorners = ExtendedTest.HelperFunctions.RotatedRectList(CornerRect, _Rotation);
